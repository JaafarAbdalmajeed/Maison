<?php
/**
 * Maison de Pierre - Sample Data Upgrader
 * Ensures sample products, categories, and brands exist
 */
...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        // Only run if version is less than 1.0.1
        if (version_compare($context->getVersion(), '1.0.1', '<')) {
            try {
                ...
                $this->logger->info('Maison Homepage: Sample data upgraded successfully');

            } catch (\Exception $e) {
                $this->logger->error('Maison Homepage: Error upgrading sample data - ' . $e->getMessage());
            }
        }
